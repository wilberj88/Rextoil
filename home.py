...
if option == 'Aluche, Madrid':
    st.write('La gasolinera de  Aluche, Madrid. Datos del 27 de junio de 2022 a 4 de noviembre de 2022: 130 días ☀️ con sus noches 🌛')
if option == 'Toledo':
    st.write('La gasolinera de Toledo con Datos en tiempo real: días ☀️ con sus noches 🌛')
...
- ⚙️: `Monitores de Costos por Horas y Productos` con `Alarmas de Altos Costos` y `Recomendaciones para más Ahorros`
- ⚙️: `Monitores de Ventas por Horas y Productos` con `Alarmas de Bajas Ventas` y `Recomendaciones para más Ventas`
- ⚙️: `Monitores de Rentabilidades por Regiones y Tráfico` con `Alarmas de Bajas Rentabilidades` y `Recomendaciones para mayores Rentabilidades`
""")
st.write('---')


#MONITORES COSTOS
st.header("Monitor 📺 de Costos 💰 por Horarios ⏰")
col1, col2, col3 = st.columns(3)
col1.metric(label ="Hora Top 1 en Costos", value = '1am', delta='362%')
col2.metric("Hora Top 2 en Costos", "7am", "317%")
col3.metric("Hora Top 3 en Costos", "2am", "289%")
...
st.write("Desagregación geográfica  de los costos de las gasolineras de rextoil para la hora ", hora_seleccionada, "en las tiendas de Madrid")
